...
class UNET_Heavy(nn.Module):
    ...
    def __init__(self):
        ...
        self.encoder_block_1 = nn.Sequential(
            nn.Conv2d(in_channels=UNET_Heavy.input_channels, out_channels=96, kernel_size=3, stride=1, padding=1, padding_mode='replicate', bias=True),
...
class UNET_Lite(nn.Module):
    ...
    def __init__(self):
        ...
        self.encoder_block_2 = nn.Sequential(
            ...
            nn.Conv2d(in_channels=64, out_channels=96, kernel_size=3, stride=1, padding=1, padding_mode='replicate', bias=True),
            nn.BatchNorm2d(num_features=96),
            nn.ReLU(inplace=True)
        )
        ...
        self.bottleneck = nn.Sequential(
            ...
            nn.Conv2d(in_channels=96, out_channels=128, kernel_size=3, stride=1, padding=1, padding_mode='replicate', bias=True),
            nn.BatchNorm2d(num_features=128),
            nn.ReLU(inplace=True),

            nn.Conv2d(in_channels=128, out_channels=128, kernel_size=3, stride=1, padding=1, padding_mode='replicate', bias=True),
            nn.BatchNorm2d(num_features=128),
            nn.ReLU(inplace=True),

            nn.ConvTranspose2d(in_channels=128, out_channels=96, kernel_size=3, stride=2, padding=1, padding_mode='zeros', output_padding=1)
        )
        ...
        self.decoder_block_2 = nn.Sequential(
            ...
            nn.ConvTranspose2d(in_channels=64, out_channels=64, kernel_size=3, stride=2, padding=1, padding_mode='zeros', output_padding=1)
        )
